...
* @Last Modified time: 2015-12-12 12:58:46
*/
...
// 		x1=ABS(ADC_value_filter[0]-ADC_middle);  //max=2048
// 		y1=ABS(ADC_value_filter[1]-ADC_middle);  
// 		x2=ABS(ADC_value_filter[2]-ADC_middle);
// 		y2=ABS(ADC_value_filter[3]-ADC_middle);
// 		//滤除小扰动
// 		if(x1>50&&y1[1]>50) 
// 		{
// 			cmd->mode=0;   //切换为手动模式
